...
globalkeys = awful.util.table.join(globalkeys,
    ...
    awful.key({ modkey, }, "d", function () awful.util.spawn("rofi -m 0 -show combi -combi-modi 'git,window,run'") end),
    awful.key({ modkey, }, "q", function () awful.util.spawn("rofi -m 0 -show git") end),
...
globalkeys = awful.util.table.join(globalkeys,
    ...
    awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn_with_shell(change_backlight("-dec 10")) end),
    awful.key({ }, "XF86MonBrightnessUp",   function () awful.util.spawn_with_shell(change_backlight("-inc 10")) end),
    awful.key({ modkey }, "XF86MonBrightnessDown", function () myredshiftwidget.toggle() end),
    awful.key({ modkey }, "XF86MonBrightnessUp",   function () myredshiftwidget.toggle() end),
